...
function displayValues() {
   ...
   window.alert(
      `Pizza Order Notice. Dear ${name} Thank you for choosing PizzaBan! Your pizza order is being processed. Delivery Details: Name:${name} Location: ${location} Contact Number: ${number} We appreciate your business and look forward to serving you..Thank you! `
   );
}
